...
import com.airportmanagement.exception.ErrorMessage;
...
class FlightControllerTest {
  ...
  void getListOfFlightsWorksProperly() {
    ...
    List<FlightWithoutCrewMembersDto> flights = response.getBody().getFlights();
  ...
  void linkUpCrewMemberWhenProvidedNonExistentCrewMemberId() {
    ...
    ResponseEntity<ErrorMessage> response = restTemplate.postForEntity(
        "/flights/{flight-id}/crew-members",
        crewMemberId,
        ErrorMessage.class,
        1L
    );
  ...
  void unlinkUpCrewMemberWhenProvidedNonExistentCrewMemberId() {
    ResponseEntity<ErrorMessage> response = restTemplate.exchange(
        "/flights/{flight-id}/crew-members/{crew-member-id}",
        HttpMethod.DELETE,
        HttpEntity.EMPTY,
        ErrorMessage.class,
        1L,
